...
public class DiscoverUsersFragment extends Fragment {
    ...
    private ReputationsViewModel viewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        final long userId = getActivity().getIntent().getLongExtra(Constants.EXTRA_USER_ID, Constants.DEFAULT_ID);
    ...
    public static ReputationsViewModel obtainViewModel(FragmentActivity activity) {
        ViewModelFactory factory = Injection.provideViewModelFactory(activity);
        return ViewModelProviders.of(activity, factory).get(ReputationsViewModel.class);
    }
    ...
    private void setupListAdapter() {
        ...
        final GridLayoutManager layoutManager =
                new GridLayoutManager(getActivity(), getResources().getInteger(R.integer.reputation_span_count));
        ...
        // observe paged list
        viewModel.getPagedList().observe(getViewLifecycleOwner(), new Observer<PagedList<Reputation>>() {
            @Override
            public void onChanged(PagedList<Reputation> users) {
                Timber.d("On Changed!");
